...
class PlaybookSearchForm(forms.Form):
    ...
    client_version = forms.CharField(label="Ansible version", max_length=255, required=False)
    server_version = forms.CharField(label="Ansible version", max_length=255, required=False)

...
It's another recursive acronym and includes simplicity as a feature.
...
While it is not necessary to run an API server as a service when recording data to a local sqlite database, the API server dependencies must be installed:
...
or using container images from [DockerHub](https://hub.docker.com/r/recordsansible/ara-api) and
...
The changelog is available directly inside the [git tags](https://github.com/ansible-community/ara/tags) as well as inside the [documentation](https://ara.readthedocs.io/en/latest/changelog-release-notes.html).
...
The ara parrot logo was contributed by [Jason E. Rist](https://github.com/ansible-community/ara/commit/0d5d0939a6b7a319d99acc1fb20d4ca282bd76ab).
